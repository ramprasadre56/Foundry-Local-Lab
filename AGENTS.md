...
```
├── labs/                              # Markdown lab guides (Parts 1–9)
├── python/                            # Python code samples (Parts 2–6)
├── javascript/                        # JavaScript/Node.js code samples (Parts 2–6)
├── csharp/                            # C# / .NET 9 code samples (Parts 2–6)
...
├── samples/audio/                     # Part 8 sample WAV files + generator script
...
- Part 9 (custom models) additionally requires `onnxruntime-genai` and downloads model weights from Hugging Face.
...
- `models/` — compiled ONNX model output (large binary files, generated by Part 9)
